...
namespace Xilium.CefGlue.Interop
{
    ...
    internal unsafe struct cef_x509certificate_t
    {
        ...
        [SuppressUnmanagedCodeSecurity]
        #endif
        private delegate CefTime get_valid_start_delegate(cef_x509certificate_t* self);
        
        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
        #if !DEBUG
        [SuppressUnmanagedCodeSecurity]
        #endif
        private delegate CefTime get_valid_expiry_delegate(cef_x509certificate_t* self);
        ...
        public static CefTime get_valid_start(cef_x509certificate_t* self)
        {
        ...
        public static CefTime get_valid_expiry(cef_x509certificate_t* self)
        {
